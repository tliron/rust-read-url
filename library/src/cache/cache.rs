...
type PathBufRefMap = LazyLock<Mutex<FastHashMap<String, PathBufRef>>>;
...
impl UrlCache {
    ...
    pub fn new(base_directory: Option<PathBuf>) -> Self {
        ...
        Self {
            base_directory,
            files: LazyLock::new(|| FastHashMap::default().into()),
            directories: LazyLock::new(|| FastHashMap::default().into()),
        }
    }
